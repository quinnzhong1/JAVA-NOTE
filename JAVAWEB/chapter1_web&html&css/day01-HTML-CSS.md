...
| 十六进制表示法 | #开头，将数字转换成十六进制表示   | #000000、#ff0000、#cccccc，简写：#000、#ccc 前两位是红色，中间两位是绿色，后面两位是蓝色，如果两位数一样，就可以只写一个，比如000000变成000，ff0000其实是把红色拉满了，可简写为f00|
...
~~~
![](assets/Screenshot%202023-08-12%20at%206.02.15%20PM.png)
...
- 视频标签: &lt;video>
  - 属性: 
    - src: 规定视频的url
    - controls: 显示播放控件 (controls="controls"时，可以简写成controls)
    - width: 播放器的宽度
    - height: 播放器的高度
...
![](assets/Screenshot%202023-08-12%20at%209.31.32%20PM.png)
...
* frameset表示页面框架
* frame表示框架中具体页面引用
  ![](asset/../assets/Screenshot%202023-08-12%20at%209.54.25%20PM.png)
...
* ![](assets/Screenshot%202023-08-12%20at%2010.09.06%20PM.png)
...
* 提示：无论是标签还是和它对应的标签，在数学等式、科学符号和化学公式中都非常有用。
...
* **相对定位 relative**
  ...
  配合padding，margin，float等使用

* **其他**
  
  static, fixed, inherit
